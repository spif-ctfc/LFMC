...
|------------------|----------------|-----------|--------------------------------|-----|
| SITES            | SitePlotcode   | integer   | not null, unique               | Primary Key |
|                  | UTM_x          | float     |                                | NA |
|                  | UTM_y          | float     |                                | NA |
|                  | County         | varchar   |                                | NA |
|                  | Town           | varchar   |                                | NA | 
...
| SITES_SPECIES    | SiteXSpecies   | integer   | not null, unique               | Primary Key |
...
|                  | SiteXSpecies   | integer   | not null                       | Foreign Key |
...
|                  | SiteCode       | integer   | not null                       | Foreign Key |
|                  | Date           | date      |                                | NA |
|                  | Time           | time      |                                | NA |
|                  | Temperature    | float     | soil temperature measured at different depths | NA |
| SOIL_MOISTURE    | SensorCode     | integer   | not null, unique               | Primary Key |
|                  | SiteCode       | integer   | not null                       | Foreign Key |
|                  | Date           | date      |                                | NA |
|                  | Time           | time      |                                | NA |

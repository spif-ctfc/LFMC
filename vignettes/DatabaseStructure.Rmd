...
|------------------|------------------|-----------|------------------------------------------------|-------------|
| SITES            | LocalitySiteCode | varchar   | not null, unique, ZoneCode and SiteCode        | Primary Key |
|                  | LocalityCode     | integer   |                                                | NA          |
|                  | SamplingSiteCode | integer   |                                                | NA          | 
...
| SITES_SPECIES    | SiteSpCode       | varchar   | not null, unique, SitePlotCode and SpeciesCode | Primary Key |
|                  | LocalitySiteCode | varchar   | not null                                       | Foreign Key |
...
|                  | ImputatedValue   | boolean   | a flag indicating LFMC imputed values          | NA          |
...
|                  | LocalitySiteCode | integer   | not null                                       | Foreign Key |
|                  | Date             | date      |                                                | NA          |
|                  | Time             | time      |                                                | NA          |

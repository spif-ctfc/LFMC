...
|                  | SamplingSiteName | varchar   |                                                | NA          |
|                  | LocalityCode     | integer   |                                                | NA          |
|                  | LocalityName     | varchar   |                                                | NA          |
|                  | Latitude         | float     |                                                | NA          |
|                  | Longitude        | float     |                                                | NA          |
...
| SITES_SPECIES    | SiteSpCode       | varchar   | not null, unique                               | Primary Key |
|                  | SamplingSiteCode | integer   | not null                                       | Foreign Key |
|                  | SpeciesCode      | integer   | not null                                       | Foreign Key |
| LFMC             | SampleCode       | varchar   | not null, unique                               | Primary Key |
|                  | SiteSpCode       | varchar   | not null                                       | Foreign Key |
|                  | Date             | date      |                                                | NA          |
|                  | FreshMass        | float     |                                                | NA          | 
|                  | DryMass          | float     |                                                | NA          | 
|                  | LFMC             | float     | derived attribute computed from FreshMass and DryMass| NA    | 
|                  | DryStem          | float     |                                                | NA          | 
|                  | DryLeaf          | float     |                                                | NA          | 
|                  | LeafStemRatio    | float     | derived attribute computed from DryLeaf and DryStem | NA     | 
|                  | LFMCOutlier      | boolean   | a flag indicating LFMC outliers manually identified | NA     |
|                  | AdditiveOutlier  | boolean   | a flag indicating LFMC additive outliers       | NA          |
...
| SOIL_TEMPERATURE | SensorCode       | varchar   | not null, unique                               | Primary Key |
|                  | SamplingSiteCode | integer   | not null                                       | Foreign Key |
|                  | Date             | date      |                                                | NA          |
|                  | Time             | time      |                                                | NA          |
...
| SOIL_MOISTURE    | SMCode           | varchar   | not null, unique                               | Primary Key |
|                  | SensorCode       | varchar   | not null, unique                               | Foreign Key |
|                  | Date             | date      |                                                | NA          |
|                  | Time             | time      |                                                | NA          |
